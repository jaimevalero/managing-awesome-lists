...
| ------------- | ------------- | ------------- |
|[donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | 70795|Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.|
|[jlevy/the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) | 63556|Master the command line in one page|
|[jakubroztocil/httpie](https://github.com/jakubroztocil/httpie) | 42651|As easy as httpie /aitch-tee-tee-pie/ 🥧 Modern command line HTTP client – user-friendly curl alternative with intuitive UI JSON support syntax highlighting wget-like downloads extensions etc. https://twitter.com/clihttp|
|[thedaviddias/Front-End-Checklist](https://github.com/thedaviddias/Front-End-Checklist) | 35751|🗂 The perfect Front-End Checklist for modern websites and meticulous developers|
|[Kickball/awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) | 34596|This is a list of Free Software network services and web applications which can be hosted locally. Selfhosting is the process of locally hosting and managing applications instead of renting from SaaS providers.|
...
|[NationalSecurityAgency/ghidra](https://github.com/NationalSecurityAgency/ghidra) | 16964|Ghidra is a software reverse engineering (SRE) framework|
...
|[tj/commander.js](https://github.com/tj/commander.js) | 15816|node.js command-line interfaces made easy|
...
|[dylanaraps/pure-bash-bible](https://github.com/dylanaraps/pure-bash-bible) | 13863|📖 A collection of pure bash alternatives to external processes.|
|[radare/radare2](https://github.com/radare/radare2) | 10784|unix-like reverse engineering framework and commandline tools|
...
|[sharkdp/fd](https://github.com/sharkdp/fd) | 10348|A simple fast and user-friendly alternative to 'find'|
...
|[vitalysim/Awesome-Hacking-Resources](https://github.com/vitalysim/Awesome-Hacking-Resources) | 8337|A collection of hacking / penetration testing resources to make you better!|
...
|[s0md3v/XSStrike](https://github.com/s0md3v/XSStrike) | 6913|Most advanced XSS scanner.|
...
|[lebinh/ngxtop](https://github.com/lebinh/ngxtop) | 5530|Real-time metrics for nginx server|
...
|[vulhub/vulhub](https://github.com/vulhub/vulhub) | 4033|Pre-Built Vulnerable Environments Based on Docker-Compose|
...
|[hslatman/awesome-threat-intelligence](https://github.com/hslatman/awesome-threat-intelligence) | 2900|A curated list of Awesome Threat Intelligence resources|
...
|[foospidy/payloads](https://github.com/foospidy/payloads) | 1822|Git All the Payloads! A collection of web attack payloads.|
...
|[j3ssie/Osmedeus](https://github.com/j3ssie/Osmedeus) | 1595|Fully automated offensive security framework for reconnaissance and vulnerability scanning|
...
|[InQuest/awesome-yara](https://github.com/InQuest/awesome-yara) | 754|A curated list of awesome YARA rules tools and people.|
...
|[bl4de/research](https://github.com/bl4de/research) | 80|Hello and welcome to my GitHub account. If you'd like to know more about me this is likely the best place to start|
